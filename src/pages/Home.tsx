...
import { Box, LayoutDashboard, Sparkles, ArrowRight } from 'lucide-react';

export function Home({ onNavigate }: { onNavigate: (route: 'closet' | 'kitchen' | 'special') => void }) {
  return (
      ...
      <main className="w-full max-w-6xl flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          ...
          >
            ...
            <p className="text-slate-400 mb-8 max-w-sm z-10 relative">Configurador paramétrico modular. Ajusta dimensiones, materiales, divisiones internas y herrajes.</p>
          ...
          >
            ...
            <div className="inline-block px-2 py-1 bg-blue-500/20 text-blue-400 text-[10px] font-bold uppercase tracking-widest rounded mb-3 z-10 relative">Motor BIM 2D/3D</div>
            <p className="text-slate-400 mb-8 max-w-sm z-10 relative">Dibuja muros en 2D y arrastra gabinetes y aéreos en 3D con imantación automática.</p>
          ...
          <div 
            ...
            className="group relative bg-zinc-900 border border-white/10 rounded-2xl p-8 hover:border-amber-500/50 transition-all cursor-pointer overflow-hidden flex flex-col items-start min-h-[320px]"
          >
            ...
            <h2 className="text-2xl font-bold uppercase tracking-wide mb-2 z-10 relative">Muebles Especiales</h2>
            <div className="inline-block px-2 py-1 bg-amber-500/20 text-amber-400 text-[10px] font-bold uppercase tracking-widest rounded mb-3 z-10 relative">Abet Laminati & Madera</div>
            <p className="text-slate-400 mb-8 max-w-sm z-10 relative">Aparador vitrina individual de autor con fondo decorativo exclusivo, marco de madera y patas de acero.</p>
